...
func (h *Handler) Upsert(w http.ResponseWriter, r *http.Request) {
	...
	item, err := h.service.Upsert(context.Background(), r.PathValue("nodeID"), command)
	if err != nil {
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	items, err := h.service.List(context.Background(), r.PathValue("nodeID"))
	if err != nil {
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	err := h.service.Delete(context.Background(), r.PathValue("nodeID"), r.PathValue("name"))
