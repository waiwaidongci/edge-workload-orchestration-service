...
func clone(item *policydomain.Policy) *policydomain.Policy {
	...
	copy.Constraints.PreferredRegions = append([]string(nil), item.Constraints.PreferredRegions...)
	copy.Constraints.RequiredRegions = append([]string(nil), item.Constraints.RequiredRegions...)
	return &copy
}
